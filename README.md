...
- Unconfigured PaperLite LLM, AI filter, or brief translation is not a blocker for QClaw, Hermes, OpenClaw, or other host agents. Do not claim cached papers were lost, the database was rebuilt, or a reinstall/reset happened unless a PaperLite tool explicitly says so.
